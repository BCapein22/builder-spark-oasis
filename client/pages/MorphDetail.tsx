...
export default function MorphDetail() {
  ...
  const morphDetails = {
    ...
    "shooting-star": {
      ...
      genetics: "Recessive",
      description:
        "A distinctive recessive morph where spots align in a straight line down the gecko's back, resembling shooting stars or candy dots. Features a unique linear pattern that sets it apart from other morphs.",
      image:
    ...
    "t-plus-albino": {
      ...
      detailed: {
        ...
        breeding:
          "Crossing with T- albinos produces double Hets offspring that appear normal. Breed T+ with T+ for consistent results.",
        care: "Standard tokay gecko care requirements",
        size: "Normal adult size range: males 12-14 inches, females 10-12 inches",
        temperament:
                    ...
                    : morph.name === "Patternless (BHG)"
                      ...
                      : morph.name === "Super Red"
                        ...
                        : morph.name === "Nightmare"
                          ? { height: "513px" }
                          : morph.name === "Shooting Star"
                            ? { height: "556px", marginBottom: "4px" }
                            : morph.name === "T+ Albino"
                              ? { height: "572px" }
                              : {}
              }
